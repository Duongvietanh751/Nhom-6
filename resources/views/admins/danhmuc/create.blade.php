...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Thêm mới anh Mục</h4>
                    ...
                    <div class="row gy-4">
                        <div class="col-md-4">
                            <div>
                                ...
                                <input type="text" class="form-control @error('ten_danh_muc') is-invalid @enderror" name="ten_danh_muc" id="name" value="{{old('ten_danh_muc')}}">
                                @error('ten_danh_muc')
